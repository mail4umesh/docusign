...
<div class="panel panel-default">
	...
	<div class="panel-body" style="padding-left: 10%; ">
		...
		<?php echo form_open('client/do_change_password','class="form-horizontal"'); ?>
			...
			<p class="submit">
				<?php
					...
					echo form_submit('submit',$submit_value,'class="left-margin-10 btn btn-default pull-right"');
					echo anchor('client','Back','class="btn left-margin-10 btn-default pull-right"'); 
				?>
			</p>
		<?php echo form_close(); ?>
	</div>
