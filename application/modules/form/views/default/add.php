    ...
    <div class="container">
        <div class="navbar-header">
           <?php
				...
				echo anchor('form','Back','class="btn left-margin-10 btn-default"'); 
			?>
		</div>
    </div>          
</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<?php
		                    ...
		                    $form_list["form1"] = "Invoice";
		                    $form_list["form2"] = "SDI ROTARY";
		                    $form_list["form3"] = "FIELD INSPECTION REPORT";
		                    $form_list["form4"] = "SDI INCOMING INSPECTION REPORT";
		                    $form_list["form5"] = "Dimensional Inspection Report";
