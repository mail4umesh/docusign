...
<div class="panel panel-default">
	<div class="panel-heading">
		<b><?php echo (@$edit) ? 'Update User - "'.$edit[0]->first_name.'"' : 'Add Admin User'; ?></b>
	</div>
