<div class="container">
	<div class="panel panel-info">
    	...
    	<div class="panel-body">
			...
			<div style="width: 100%">
				<?php echo anchor('inspector','Back','class="btn left-margin-10 btn-info pull-right"'); ?>
				<?php echo anchor('inspector/edit/'.$user->id,'Modify','class="btn left-margin-10 btn-default pull-right"'); ?>	
			</div>
