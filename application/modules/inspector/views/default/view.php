<div class="navbar toolbar navbar-default">
    <div class="container">
        <div class="navbar-header">
			<?php echo anchor('inspector','<i class="glyphicon glyphicon-arrow-left"> </i> Back','class="btn left-margin-10 btn-info pull-right"'); ?>
			<?php echo anchor('inspector/edit/'.$user->id,'<i class="glyphicon glyphicon-edit"> </i>  Modify','class="btn left-margin-10 btn-default pull-right"'); ?>	
		</div>
    </div>          
</div>
	...
	<div class="panel panel-default">
    	...
    	<div class="panel-body">
			...
			<dl class="container">
				...
				<dd class="col-md-6">
					<a href="<?php echo base_url()."inspector/change_password/".$user->id ?>">Change Password</a>
